...
galaxies = {
    'target' : galcol.parameters(5e10, 10, (0,0,0), (0,0,0), (0,0,1), 10, 4000, 0.025),
}
...
galcol.show_orbits(range(50,4000,350), data)
galcol.anim_orbits(range(50,4000,350), data, [-15,15], [-15,15], name='isolated_disk_orbits_tstep_0_05')

# In[ ]:


galcol.anim_disk_2d(data, [-15,15], [-15,15], name='isolated_disk_tstep_0_05')
